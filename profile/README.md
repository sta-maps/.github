# STA-Maps: Sociotechnical Architecture Maps 
...
## Getting Started
In order to get started you should check out the [Introduction](https://github.com/sta-maps/introduction) Repository
